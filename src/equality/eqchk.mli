...
val add_type_computation : checker -> Nucleus.judgement_rule -> checker option

(** Add a term computation rule (also known as β-rule *)
val add_term_computation : checker -> Nucleus.judgement_rule -> checker option

(** Add an extensionality rule *)
val add_extensionality : checker -> Nucleus.judgement_rule -> checker option
...
val add : quiet:bool -> penv:Nucleus.print_environment -> checker -> Nucleus.judgement_rule -> checker option
